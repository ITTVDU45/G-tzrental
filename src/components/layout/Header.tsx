...
const companyMenuItems: MenuItem[] = [
    ...
    },
    {
        title: "Standorte",
        icon: "📍",
        description: "Deutschlandweit für Sie da",
        link: "#",
        submenu: [
            { name: "Düsseldorf", link: "/unternehmen/standorte/duesseldorf" },
            { name: "München", link: "/unternehmen/standorte/muenchen" },
            { name: "Berlin", link: "/unternehmen/standorte/berlin" },
            { name: "Hamburg", link: "/unternehmen/standorte/hamburg" }
        ]
    },
    {
                                                    ...
                                                    <div className="p-6">
                                                        <div className="grid grid-cols-2 gap-3">
                                                            {(item.name === "Service" ? serviceMenuItems : companyMenuItems).map((menuItem, idx) => (
                                                                ...
                                                                >
                                                                    {menuItem.submenu ? (
                                                                        // Render menu item with side popup for Standorte
                                                                        <div
                                                                            className={cn(
                                                                                "group/submenu block p-4 rounded-2xl transition-all duration-300 cursor-pointer",
                                                                                "bg-zinc-50 dark:bg-zinc-800/50 hover:bg-zinc-100 dark:hover:bg-zinc-800"
                                                                            )}
                                                                        >
                                                                            <div className="flex items-start gap-3">
                                                                                <div className="text-2xl p-2 rounded-xl bg-white dark:bg-zinc-900">
                                                                                    {menuItem.icon}
                                                                                </div>
                                                                                <div className="flex-1 min-w-0">
                                                                                    <h4 className="font-bold text-sm mb-1 text-zinc-700 dark:text-zinc-300 group-hover/submenu:text-brand-teal transition-colors">
                                                                                        {menuItem.title}
                                                                                    </h4>
                                                                            ...
                                                                            {/* Side Popup for Cities */}
                                                                            <div className="absolute left-full top-0 ml-2 w-48 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-100 dark:border-zinc-800 p-3 opacity-0 invisible group-hover/submenu:opacity-100 group-hover/submenu:visible transition-all duration-300 z-50">
                                                                                <div className="space-y-1">
                                                                                    {menuItem.submenu.map((subItem: any) => (
                                                                                        <Link
                                                                                            key={subItem.name}
                                                                                            href={subItem.link}
                                                                                            className="block px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400 hover:text-brand-teal hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded-lg transition-colors"
                                                                                        >
                                                                                            {subItem.name}
                                                                                        </Link>
                                                                                    ))}
